...
- (id)initWithTitle:(NSString *)title message:(NSString *)message defaultText:(NSString*)defaultText block: (TextFieldReturnCallBack) block {
    ...
    if (self) {
        UITextField *theTextField = [[[UITextField alloc] initWithFrame:CGRectMake(kTextBoxHorizontalMargin+10, _height, _view.bounds.size.width - kTextBoxHorizontalMargin * 2-20, kTextBoxHeight)] autorelease];
        ...
        theTextField.placeholder=@"请输入手机号码";
        if (defaultText)
