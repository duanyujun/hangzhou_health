...
@interface XueYaUploadViewController ()<UIAlertViewDelegate,UITableViewDelegate,UITableViewDataSource,MBAccessoryViewDelegate>
{
...
@implementation XueYaUploadViewController
...
-(void)uploadData
{
    ...
    NSString *valueStr =[NSString stringWithFormat:@"<string>%@</string><string>%@</string><string>%@</string>",_threeTF.text,_fourTF.text,_fiveTF.text];
    ...
    NSLog(@"%@",soapMsg);
    __block XueYaUploadViewController *blockSelf = self;
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"XueYaUploadSuccess" object:nil];
