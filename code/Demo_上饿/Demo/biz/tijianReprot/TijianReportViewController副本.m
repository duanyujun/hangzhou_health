...
-(void)getGetReportAbnoramlAndItemsSuccess:(NSString *)string
{
    ...
    @try {
        ...
        if ([array isKindOfClass:[NSArray class]]) {
            ...
            NSLog(@"%@",[NSDictionary dictionaryWithXMLString:string]);
            ...
            NSLog(@"1111======%@",resutlDic[@"data"]);
            NSLog(@"111=====%@,2222=======%@",all.advice,all.summarize);
