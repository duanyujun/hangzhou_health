                 ...
                 fromRect:(CGRect)fromRect
{
    ...
    _contentView.backgroundColor=HEX(@"#5ec4fe");
}
...
- (UIView *) mkContentView
{
    ...
    const CGFloat kMinMenuItemHeight = 30.0f;
...
//    UIFont *titleFont = [MBPopMenu titleFont];
    ...
    contentView.backgroundColor = HEX(@"#5ec4fe");
    ...
    for (MBPopMenuItem *menuItem in _menuItems) {
        ...
        itemView.backgroundColor = HEX(@"#5ec4fe");
        ...
        if (itemNum < _menuItems.count - 1) {
            ...
            gradientView.frame = CGRectMake(0, maxItemHeight, maxItemWidth, 1);
            gradientView.backgroundColor=HEX(@"#ffffff");
