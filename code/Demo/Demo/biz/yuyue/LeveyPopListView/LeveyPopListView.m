...
{
    CGRect rect = CGRectMake(POPLISTVIEW_SCREENINSET,
                             POPLISTVIEW_HEADER_HEIGHT,
                             kScreenWidth - 2 * POPLISTVIEW_SCREENINSET,
                             kScreenHeight - 2 * (POPLISTVIEW_SCREENINSET + POPLISTVIEW_HEADER_HEIGHT));
    ...
    if (self = [super initWithFrame:rect])
    {
        ...
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(5, POPLISTVIEW_HEADER_HEIGHT+POPLISTVIEW_SCREENINSET, rect.size.width-30, rect.size.height-POPLISTVIEW_SCREENINSET -POPLISTVIEW_SCREENINSET-POPLISTVIEW_HEADER_HEIGHT)];
