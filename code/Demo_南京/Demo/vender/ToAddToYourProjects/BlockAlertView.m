...
- (id)initWithTitle:(NSString *)title message:(NSString *)message 
{
    if ((self = [super init]))
    {
        ...
        if (title)
        {
            ...
            UILabel *labelView = [[UILabel alloc] initWithFrame:CGRectMake(kAlertViewBorder+10, _height+10, frame.size.width-kAlertViewBorder*2-20, size.height)];
        ...
        if (message)
        {
            ...
            UILabel *labelView = [[UILabel alloc] initWithFrame:CGRectMake(kAlertViewBorder+10, _height, frame.size.width-kAlertViewBorder*2-20, size.height)];
...
- (void)show
{
    ...
    for (NSUInteger i = 0; i < _blocks.count; i++)
    {
        ...
        else if (_blocks.count  == 1)
        {
            ...
            {
                width = size.width + 2 * kAlertViewBorder-10;
                xOffset = floorf((_view.bounds.size.width - width) * 0.5);
            }
        }
        
        UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
        button.frame = CGRectMake(xOffset+10, _height, width-20, kAlertButtonHeight-5);
