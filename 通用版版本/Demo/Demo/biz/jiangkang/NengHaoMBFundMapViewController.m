...
@interface NengHaoMBFundMapViewController ()

@end

@implementation NengHaoMBFundMapViewController
...
- (void)viewDidLoad
{
    ...
    for (int i=0; i<reseDataArray.count; i++) {
        [one addObject:MBNonEmptyStringNo_(reseDataArray[i][@"HD19"])];
        [two addObject:MBNonEmptyStringNo_(reseDataArray[i][@"HD54"])];
        [three addObject:MBNonEmptyStringNo_(reseDataArray[i][@"HD55"])];
